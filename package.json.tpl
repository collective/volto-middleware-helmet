{
  "name": "volto-middleware-helmet",
  "version": "0.1.0",
  "description": "volto-middleware-helmet: Volto add-on",
  "main": "src/index.js",
  "author": "European Environment Agency: IDM2 A-Team",
  "license": "MIT",
  "homepage": "https://github.com/eea/volto-middleware-helmet",
  "keywords": [
    "volto-addon",
    "volto",
    "plone",
  ...
  "repository": {
    "type": "git",
    "url": "git@github.com:eea/volto-middleware-helmet.git"
  },
  "dependencies": {
    "@plone/scripts": "*"
  },
