...
class Html extends Component {
  ...
  render() {
    ...
    /*
     * Call for the CSP header component
     * Has been moved from <meta> tag of html to simple function call.
     * The CSP Headers will be activly set by helmet-middleware
     */

    // Import the CSP nonce from the config
    const cspNonce = config.settings.cspNonce;

    // Apply the nonce to all scripts except [windowEnvScript, CRITICAL_CSS_TEMPLATE, windowDataScript]
    const head = Helmet.rewind();
    
    head.script.toComponent().forEach((script) => {
      script.props.nonce = cspNonce;
    });
